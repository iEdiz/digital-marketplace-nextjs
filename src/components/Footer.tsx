            ...
            <div>
              <div className="relative flex items-center px-6 py-6 sm:py-8 lg:mt-0">
                ...
                <div className="text-center relative mx-auto max-w-sm">
                  <h3 className="font-semibold text-gray-900">Support MegurixShop</h3>
                  <p className="mt-2 text-sm text-muted-foreground">
                    If you are a book worm and love bookish merch, feel free to check out what we have to offer!
                  </p>
                </div>
              </div>
            </div>
