...
export const ReceiptEmail = ({ email, date, orderId, products }: ReceiptEmailProps) => {
  const total = products.reduce((acc, current) => acc + current.price, 0) + 1; //Transaction fee

  return (
    <Html>
      <Head />
      <Preview>Your MegurixShop Receipt</Preview>
              ...
              <Section key={product.id}>
                <Column style={{ width: "64px" }}>
                  {typeof image !== "string" && image.url ? (
                    <Img src={image.url} width="64" height="64" alt="Product Image" style={productIcon} />
                  ) : null}
                </Column>
